...
import { COURSES_PAGE_ROUTE, COURSE_PAGE_ROUTE, DASHBOARD_MAIN_PAGE_ROUTE, FAQ_PAGE_ROUTE, HOME_PAGE_ROUTE, LOGIN_PAGE_ROUTE, REGISTER_PAGE_ROUTE, SUPPORT_PAGE_ROUTE } from "./consts";
